    ...
    <Fragment>
     <ListGroupItem>
      ...
      <ListGroupItem>
          ...
          <Link to="/checkout" style={styles.centerButtons}><Button className='p-3 mb-2 bg-dark text-white' size="md">Check out</Button></Link>
          <Link to="/cart" style={styles.centerButtons}><Button outline color="secondary" size="md">View Cart</Button></Link>
