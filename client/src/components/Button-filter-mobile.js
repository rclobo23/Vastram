...
class ButtonFilterMobile extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Button  className="fa fa-filter rounded border-0" style={{position:'absolute', background:'#000', height: '40px',top:'-35px', right:'20px', zIndex:'999', fontSize:'20px', }} onClick={this.toggle}><small> Sort</small></Button>
