...
const CheckoutStepTwo = ({
  ...
  return (
    ...
    <h4 style={styles.collapasePannelTitle} onClick={()=>step2Unlock && toggle('step2')}>
      <Badge color="secondary" pill size='sm'>2</Badge>  Shipping & Contact {}
    </h4>
      ...
      <Row>
        ...
        <Col md={6} style={styles.formFieldsSpace}>
         ...
         <Col md={6} style={styles.formFieldsSpace}>
          ...
          <Input type="text" disabled name="select" onChange={onChangeCountry} value={country}>                 
          </Input>
        </Col> 
        <Col md={6} style={styles.formFieldsSpace}>
          <Label>State/Province</Label>
          <Input type='select' disabled onChange={onChangeProvince} value={province} >
