 ...
 <Container>
  ...
  <Col xs={6}  md={3} className="text-small">
    <div style={{paddingTop:'10px'}}>Contact </div>
        ...
        <div className="mt-3" style={{paddingTop:'1px', textAlign: 'left',}}><a href="https://www.instagram.com/vastramboutiquemangalore/"><span className="fa fa-instagram mx-2 " style={{color:"#000"}}/></a><span className="fa fa-facebook mx-2 " style={{color:"#000"}}/> <span className="fa fa-youtube-play mx-2" style={{color:"#000"}}/><span className="fa fa-envelope mx-2" style={{color:"#000"}}/><span className="fa fa-phone mx-2" style={{color:"#000"}}/></div>
        <div style={{ paddingTop:'10px'}}><small>Pailands Building, 2nd Floor,   <br/> Opp. Hamppankatta Post Office Mangalore-575001</small></div>
  </Col>
  ...
  <div style={{ paddingTop:'10px'}}><small>Privacy Policy</small></div>
        ...
        <div style={{ paddingTop:'10px'}}><small>Developed by <a href="https://instagram.com/tikan.ga">WAR</a></small></div>
        </Col>
   </Row>
</Container>
  </div>    
